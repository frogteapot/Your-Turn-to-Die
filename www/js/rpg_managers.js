...
DataManager._databaseFiles = [
    ...
    { name: '$dataCommonEvents', src: 'CommonEvents2.json' },
    { name: '$dataCommonEvents2', src: 'CommonEvents.json' },
...
DataManager.onLoad = function(object) {
    ...
    if (object === $dataSystem) {
        Decrypter.hasEncryptedImages = $encryptImages; // !!object.hasEncryptedImages;
        Decrypter.hasEncryptedAudio = false; // !!object.hasEncryptedAudio;
...
PluginManager._path         = $dataFolder + 'js/plugins/';
